...
[![CRAN](http://www.r-pkg.org/badges/version/faroutman)](http://cran.rstudio.com/package=faroutman) 
[![Downloads](http://cranlogs.r-pkg.org/badges/faroutman?color=brightgreen)](http://www.r-pkg.org/pkg/faroutman)
...
found on [github](https://www.github.com/shabbychef/faroutman "faroutman")
via devtools, or installed via [drat](https://github.com/eddelbuettel/drat "drat"):

```{r install,eval=FALSE,echo=TRUE}
if (require(devtools)) {
	# latest greatest
	install_github('shabbychef/faroutman')
}
# via drat:
if (require(drat)) {
	drat:::add('shabbychef')
